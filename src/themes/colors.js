...
export const blackFade10 = 'rgba(0, 0, 0, 0.01)';
export const blackFade100 = 'rgba(0, 0, 0, 0.1)';
export const blackFade200 = 'rgba(0, 0, 0, 0.2)';
export const blackFade300 = 'rgba(0, 0, 0, 0.3)';
export const blackFade350 = 'rgba(0, 0, 0, 0.35)';
export const blackFade400 = 'rgba(0, 0, 0, 0.4)';
export const blackFade500 = 'rgba(0, 0, 0, 0.5)';
export const blackFade600 = 'rgba(0, 0, 0, 0.6)';
export const blackFade700 = 'rgba(0, 0, 0, 0.7)';
export const blackFade800 = 'rgba(0, 0, 0, 0.8)';
export const blackFade860 = 'rgba(0, 0, 0, 0.86)';
export const blackFade900 = 'rgba(0, 0, 0, 0.9)';

export const whiteFade100 = 'rgba(255, 255, 255, 0.1)';
export const whiteFade200 = 'rgba(255, 255, 255, 0.2)';
export const whiteFade300 = 'rgba(255, 255, 255, 0.3)';
export const whiteFade400 = 'rgba(255, 255, 255, 0.4)';
export const whiteFade500 = 'rgba(255, 255, 255, 0.5)';
export const whiteFade600 = 'rgba(255, 255, 255, 0.6)';
export const whiteFade700 = 'rgba(255, 255, 255, 0.7)';
export const whiteFade800 = 'rgba(255, 255, 255, 0.8)';
export const whiteFade900 = 'rgba(255, 255, 255, 0.9)';
export const whiteFade950 = 'rgba(255, 255, 255, 0.95)';

export const black = '#000000';
export const white = '#ffffff';
export const transparent = 'transparent';
export const blurYellow = '#f1c40f';
export const blurBricky = '#e67f22';
export const drawer = '#373445';
export const dark = '#12132c';
export const txtDark = '#3d3d3d';
export const darkGreen = '#225e41';
export const green = '#27ae61';
export const yellowishOrange = '#ffa50b';
export const red = '#e54d3e';
export const blueGrey = '#a6a7bd';
export const warmGrey = '#afafaf';
export const lightGrey = '#ccd3db';
export const darkGreyBlue = 'rgb(41, 34, 103)';
export const sunYellow = '#f3da22';
export const redTwo = '#e30804';
export const blackOne = '#2b2b2b';
export const blackTwo = '#4a4a4a';
export const lightBlack = '#747474';
export const whiteOne = '#f2f2f2';
export const whiteTwo = '#e7e7e7';
export const whiteThree = '#d8d8d8';
export const whiteEdit = '#f4f4f4';
export const lightRed = '#F64C4C';
export const lightBlue = '#324269';
export const blueTwo = '#336BDE';
export const textBlue = '#2E4168';
export const divider = '#eeeeee';
export const primaryDark = '#303F9F';
export const primaryColor = '#0088E5';
export const primaryLightColor = '#0088FF';
export const secondaryColor = '#FF8900';
export const grey = '#A7A7A7';
export const textGrey = '#666666';
export const darkGrey = '#909090';
export const darkBlue = '#2e4168';
export const darkBlueTwo = '#3c72cf';
export const blurGrey = '#bababa';

export const emergencyGroup = '#E94B35';
export const reportGroup = '#FFC635';
export const helpGroup = '#4D9C67';
export const zalo = '#42adf4';
export const facebook = '#667EB9';

export const bgIntro1 = 'rgb(238, 70.5, 71.5)';
export const bgIntro2 = 'rgb(103,103,103)';
export const bgIntro3 = 'rgb(65,197,236)';

export const purpleHeart = 'rgb(184,33,206)'; // #B821CE
export const purpleHeartFade200 = 'rgba(184,33,206,0.2)';

export const textBlack = '#192038';
export const cadetBlue = '#AEB6C7';
export const textLightGray = '#8F9BB3';
export const textGray = '#737F97';
export const bgIcon = '#EDF1F7';
export const serenade = '#FFF3E5';
export const divideLine = '#E6E9EE';
export const live = '#FF3D71';
export const darkBlueFade = 'rgba(34, 43, 69, 0.5)';

export const primary =  purpleHeart;
